...
for (i = 1; i <= 9; i += 1) {
    document.getElementById(`pic${i}`).onmouseover = ccc = () => {
        console.log(i)
        // aaa(i)
    }
    // document.getElementById(`pic${i}`).onmouseout = () => {
    //     // bbb(i)
    // }
    console.log(i)
};
// console.log(i)
// let aaa = (x) => {
//     document.getElementById(`pic${x}`).src = `./img/ice0${x}-1.jpg`
// }

// let bbb = (x) => {
//     document.getElementById(`pic${x}`).src = `./img/ice0${x}.jpg`
// }
